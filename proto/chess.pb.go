...
const file_proto_chess_proto_rawDesc = "" +
	"\n" +
	"\x11proto/chess.proto\x12\x05chess\"I\n" +
	"\vMoveRequest\x12\x12\n" +
	"\x04from\x18\x01 \x01(\tR\x04from\x12\x0e\n" +
	"\x02to\x18\x02 \x01(\tR\x02to\x12\x16\n" +
	"\x06player\x18\x03 \x01(\tR\x06player\"B\n" +
	"\fMoveResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage2C\n" +
	"\fChessService\x123\n" +
	"\bMakeMove\x12\x12.chess.MoveRequest\x1a\x13.chess.MoveResponseB\x0fZ\rproto/chesspbb\x06proto3"
...
var file_proto_chess_proto_depIdxs = []int32{
	0, // 0: chess.ChessService.MakeMove:input_type -> chess.MoveRequest
	1, // 1: chess.ChessService.MakeMove:output_type -> chess.MoveResponse
